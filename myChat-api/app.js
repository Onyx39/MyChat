 ...
 */
mongoose.connect(`mongodb://${mongoDBHost}:27017/myChat`, options, function (err) {
    if (err) {
        throw err;
    }
    ...
    const passwordEncrypted = crypto.createHash('sha256').update("prout").digest("hex");
    const adminUser = {
        prenom: "Val",
        nom: "Ric",
        pseudo : "admin",
...
console.log("Everything should be okay...");